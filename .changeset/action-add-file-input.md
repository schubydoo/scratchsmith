...
pack flag of the same name, so the rules do not change: regular files only, and a missing source,
a directory, or a destination already in the image fails the pack. Before this, the flag was
